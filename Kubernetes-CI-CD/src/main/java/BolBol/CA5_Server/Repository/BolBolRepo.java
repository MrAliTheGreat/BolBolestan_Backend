...
public class BolBolRepo{
    ...
    public void createAllTables(){
        try {
            new StudentMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }

        try {
            new OfferingMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            new PassedCourseMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }

        try {
            new TakenCoursesMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }

        try {
            new WaitingListMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }

        try {
            new SelectedNowMapper(true);
        }catch (Exception e) {
            e.printStackTrace();
        }
    }
